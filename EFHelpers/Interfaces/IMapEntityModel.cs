...
namespace Ducksoft.Soa.Common.EFHelpers.Interfaces
{
    ...
    public interface IMapEntityModel
    {
        ...
        /// <returns></returns>
        int Create<TDTO, TEntity, TAudit>(TDTO objectToCreate,
        ...
        /// <param name="cancelToken">The cancel token.</param>
        /// <returns></returns>
        int Update<TDTO, TEntity, TAudit>(TDTO objectToUpdate, bool isTracked = false,
            CancellationToken cancelToken = default(CancellationToken))
            where TDTO : class
            where TEntity : class
            where TAudit : struct;
        ...
        /// <param name="cancelToken">The cancel token.</param>
        /// <returns></returns>
        int Delete<TDTO, TEntity, TAudit>(TDTO objectToDelete, bool isTracked = false,
            CancellationToken cancelToken = default(CancellationToken))
            where TDTO : class
            where TEntity : class
            where TAudit : struct;
        ...
        /// <param name="cancelToken">The cancel token.</param>
        /// <returns></returns>
        int Delete<TEntity, TAudit>(string odataFilterExpression, TAudit userId,
            CancellationToken cancelToken = default(CancellationToken))
            where TEntity : class
            where TAudit : struct;
